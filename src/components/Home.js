      ...
      return (
        <div className="splash-height">
            ...
            <section className="hero">
              ...
              <div className="hero-copy">
                ...
                <p>
                  ...
                  <a className="contactlink" href="mailto:merrilj@yahoo.com?Subject=Hello%20friend" target="_top">merrilj@yahoo.com</a> <br />
                </p>
              </div>
            </section>
          ...
          <section className="social-icons-row-main">
            ...
            <a href="https://www.instagram.com/gerpha" target="_blank"><img className="social-icon float" src="img/ig.svg" alt="instagram logo img" /></a>
          ...
          return (
            <ProjectIndex type={this.state.projectFilterType} hashtag={this.state.projectFilterTag} _filterProjectsTag={this._filterProjectsTag} _filterProjectsType={this._filterProjectsType} />
          )
